...
document.getElementById("pedido-form").addEventListener("submit", function (e) {
  ...
  const texto = `Hola, soy ${nombre}. Mi número es ${telefono}. Quisiera hacer un pedido con el siguiente detalle: ${mensaje}`;
  const numeroWhatsApp = "56912345678"; // Reemplaza con tu número sin el "+" ni espacios
